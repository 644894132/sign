<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:89:"D:\phpstudy\PHPTutorial\WWW\sign\public/../application/admin\view\cartogram\classify.html";i:1570961494;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\head.html";i:1570699778;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\foot.html";i:1570788077;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
  ...
  option = {
    ...
    feature : {
     ...
     $.ajax({
        type: 'post',
        async :true,
        url :"<?php echo url('Cartogram/college'); ?>",
        data :[],
        dataType :'json',
