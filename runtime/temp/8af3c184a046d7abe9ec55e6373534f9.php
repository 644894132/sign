<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:93:"D:\phpstudy\PHPTutorial\WWW\sign\public/../application/admin\view\panel\assign_personnel.html";i:1572572910;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\head.html";i:1570699778;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\foot.html";i:1572573889;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
...
<div class="layui-input-inline">
 <input type="text" class="layui-input" value="<?php echo $data['seek']; ?>" id="seek" style="width:320px;" placeholder="请输入个人编号/姓名">
</div>
...
<script type="text/javascript"> 
     ...
     function searchs(curpage){
      ...
      var url ='<?php echo url("Panel/assign_personnel"); ?>?labelid='+labelid+"&page="+curpage;
      //var_dump(url);
      if(seek){
        //将搜索到的内容拼接至分页后面
        url+='&seek='+seek;
    ...
    layer.confirm('确认要删除吗?', {
      ...
      //提交数据，跳转页面
      $.post("<?php echo url('Panel/remove'); ?>",{'checkAll':arr,'id':id},function(res){
        if(res.code>0){
            layer.alert(res.msg,{icon:2});
        }else{
            layer.msg(res.msg);
