<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:96:"D:\phpstudy\PHPTutorial\WWW\sign\public/../application/admin\view\panel\update_father_menus.html";i:1572592082;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\head.html";i:1570699778;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\foot.html";i:1572573889;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
  ...
  <form class="layui-form">  
      ...
      <tr>                        
       <td>
        ...
        <div class="layui-input-inline">        
          <input type="text"  name="title" class="layui-input" value="$data.item.title">
        </div> 
        </div>
       </td>              
      </tr>
     ...
     <thead>
      <tr>                        
       <td>
        ...
        <div class="layui-input-inline">         
          <input type="text"  name="icon" class="layui-input" value="$data.icon" >
        </div> 
        </div>
       </td>              
      </tr>
    ...
    <div class="layui-form-item"> 
      <button type="button" class="layui-btn" style="margin-left:120px" onclick="save_father()">保存</button>
    </div>    
  </form>  
<script type="text/javascript" src="/static/plugins/layui/layui.js"></script>
...
<script type="text/javascript">
 //保存
 function save_father(mid){
  console.log(mid);
   var title =$.trim($('input[name ="title"]').val());
   var icon =$.trim($('input[name ="icon"]').val()); 
   $.post('<?php echo url("Panel/save_father"); ?>',{'mid':mid,'title':title,'icon':icon},function(res){
    if(res.code>0){
      layer.alert(res.msg,{icon:2});
    }else{
      layer.msg(res.msg);
