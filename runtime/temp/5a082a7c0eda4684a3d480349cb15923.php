<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"D:\phpstudy\PHPTutorial\WWW\sign\public/../application/admin\view\meeting\index.html";i:1572862769;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\head.html";i:1570699778;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\foot.html";i:1572849076;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
...
<table class="layui-table">
  ...
  <thead>
   ...
   <tr>
    ...
    <td>
    <button class="layui-btn" title="编辑" onclick="meeting_add(<?php echo $vo['id']; ?>, 1)"><i class="layui-icon">&#xe642;</i></button> 
    <button class="layui-btn layui-btn-danger" title="删除" onclick="remove(<?php echo $vo['id']; ?>)"><i class="layui-icon">&#xe640;</i></button>
    <a href="<?php echo url('Meeting/homepage'); ?>?MeetingID=<?php echo $vo['id']; ?>" style="text-decoration:none" class="layui-btn layui-btn-normal" title="邀请"><i class="layui-icon">&#xe654;</i></a>
    </td>
   </tr>
...
<script type="text/javascript"> 
    ...
    layui.use(['layer','laypage'],function(){
      ...
      //引用jquery
       ...
       function searchs(curpage){
        ...
        //有wd就加载至分页后面
        var url ="<?php echo url('Meeting/index'); ?>?page="+curpage;
        //var_dump(url);
        if(seek){
          //将搜索到的内容拼接至分页后面
          url+='&seek='+seek;
    ...
    function remove(id,Account){
      ...
      layer.confirm('确认要删除吗?',{
        ...
        //提交数据，跳转页面
        $.post('<?php echo url("Meeting/delete"); ?>',{'id':id,'Account':Account},function(res){
          if(res.code>0){
