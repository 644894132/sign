<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:88:"G:\PHPstudayV8\phpstudy_pro\WWW\sign\public/../application/admin\view\home\userinfo.html";i:1571815790;s:76:"G:\PHPstudayV8\phpstudy_pro\WWW\sign\application\admin\view\common\head.html";i:1570699779;s:76:"G:\PHPstudayV8\phpstudy_pro\WWW\sign\application\admin\view\common\foot.html";i:1572849076;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
      ...
      <table class="layui-table">
         <thead>
           <?php if(is_array($data['lists']) || $data['lists'] instanceof \think\Collection || $data['lists'] instanceof \think\Paginator): $i = 0; $__LIST__ = $data['lists'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            ...
            <tr>
              <th>性别</th>
              <th><?php echo $vo['Sex']==1?'男':'女'; ?></th>
            </tr>
            <tr>
              <th>出生日期</th>
              <th><?php echo $vo['DateOfBirth']; ?></th>
            </tr>
            <tr>
              <th>邮箱</th>
            ...
            <tr>
              <th>电话</th>
              <th><?php echo $vo['Aphone']; ?></th>
            </tr>
            <tr>
              <th>籍贯</th>
              <th><?php echo $vo['NativePlace']; ?></th>
            </tr>
            <tr>
              <th>民族</th>
              <th><?php echo $vo['FamilyName']; ?></th>
            </tr>
             <tr>
              <th>政治面貌</th>
              <th><?php echo $vo['PoliticalOutlook']; ?></th>
            </tr>
            <tr>
              <th>登录时间</th>
              <th><?php echo $vo['LoginTime']; ?></th>
            </tr>
            <tr>
              <th>登录地点</th>
              <th><?php echo $vo['LoginAddress']; ?></th>
            </tr>
            <tr>
              <th>登录IP</th>
              <th><?php echo $vo['LoginIP']; ?></th>
            </tr>
            <tr>
              <th>角色</th>
