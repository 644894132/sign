<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"G:\PHPstudayV8\phpstudy_pro\WWW\sign\public/../application/admin\view\home\welcome.html";i:1568890882;s:76:"G:\PHPstudayV8\phpstudy_pro\WWW\sign\application\admin\view\common\head.html";i:1570699779;s:76:"G:\PHPstudayV8\phpstudy_pro\WWW\sign\application\admin\view\common\foot.html";i:1572849076;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
...
<table class="layui-table">
 <thead>
   <?php if(is_array($data['lists']) || $data['lists'] instanceof \think\Collection || $data['lists'] instanceof \think\Paginator): $i = 0; $__LIST__ = $data['lists'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
    ...
    <tr>
      <th>登录时间</th>
      <th><?php echo date('Y-m-d H:i',$vo['LoginTime']); ?></th>
    </tr>
    <tr>
      <th>退出登录时间</th>
      <th><?php echo date('Y-m-d H:i',$vo['LoginoutTime']); ?></th>
    </tr>
    <tr>
      <th>登录地点</th>
