...
<form class="layui-form">
  <table class="layui-table">
    ...
    <thead>
      <?php if(is_array($result) || $result instanceof \think\Collection || $result instanceof \think\Paginator): $key = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?> 
      <tr>
        <td style="color:red"><b><?php echo $vo['mid']; ?></b></td>
        <td class="layui-icon"><?php echo $vo['icon']; ?></td>       
        <td style="color:red"><?php echo $vo['title']; ?></td>
        <td></td>
        <td></td>
      </tr> 
      ...
      <tr>        
        <td><?php echo $cvo['mid']; ?></td>
        <td></td>       
        <td><?php echo $cvo['title']; ?></td>
        <td><?php echo $cvo['controller']; ?></td>
        <td><?php echo $cvo['method']; ?></td>
      </tr>  
