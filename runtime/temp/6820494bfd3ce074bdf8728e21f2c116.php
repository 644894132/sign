<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"D:\phpstudy\PHPTutorial\WWW\sign\public/../application/admin\view\gather\conferee.html";i:1571730032;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\head.html";i:1570699778;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\foot.html";i:1572573889;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
   ...
   $("#year").trigger("click");
    ...
    function month(obj){
     ...
     $.ajax({
        type: 'post',
        async :true,
        url :"<?php echo url('Gather/month_conferee'); ?>",
        data :[],
        dataType :'json',
   ...
   function year(obj){
    ...
    $("#month").removeClass("active");
     ...
     $.ajax({
        type: 'post',
        async :true,
        url :"<?php echo url('Gather/year_conferee'); ?>",
        data :[],
        dataType :'json',
        success :function(data){
            //json数据转为数组
