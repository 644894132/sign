<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:94:"D:\phpstudy\PHPTutorial\WWW\sign\public/../application/admin\view\meeting\meeting_content.html";i:1565852434;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\head.html";i:1566614346;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\foot.html";i:1567147564;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
  ...
  <body  class="layui-layout-body">
     ...
     <div class="header">
      <span>会议内容</span>
      <button class="layui-btn layui-btn-xs" onclick="go()">返回上一级</button>
      <div></div>
     </div>
     <br>
      <table class="layui-table">
        <?php if(is_array($data['lists']) || $data['lists'] instanceof \think\Collection || $data['lists'] instanceof \think\Paginator): $i = 0; $__LIST__ = $data['lists'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
         <tr>
           <td class="meeting_content"><?php echo $vo['content']; ?></td>
         </tr>
...
<script type="text/javascript">
    //返回上一级
    function go(){
    	setTimeout(function(){window.location.href="/admin.php/admin/Meeting/index"},500);
    }
</script>
