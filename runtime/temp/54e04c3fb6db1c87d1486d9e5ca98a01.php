<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"D:\phpstudy\PHPTutorial\WWW\sign\public/../application/admin\view\panel\add_menus.html";i:1572595178;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\head.html";i:1570699778;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\foot.html";i:1572573889;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
        ...
        <div class="layui-input-inline">         
          <select>
            ...
            <?php if(is_array($result) || $result instanceof \think\Collection || $result instanceof \think\Paginator): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
              <option value="<?php echo $vo['title']; ?>" name="mid"><?php echo $vo['title']; ?></option>
     ...
     <thead>
      <tr>                        
       <td>
        ...
        <div class="layui-input-inline">         
          <input type="text"  name="title" class="layui-input" placeholder="请输入栏目名称" >
        </div> 
        </div>
       </td>         
     </tr>
     ...
     <thead>
      <tr>                        
       <td>
        ...
        <div class="layui-input-inline">         
          <input type="text"  name="icon" class="layui-input" placeholder="请输入图标">
        </div> 
        </div>
       </td>         
     </tr>
     ...
     <thead>
      <tr>                        
       <td>
        ...
        <div class="layui-input-inline">         
          <input type="text"  name="controller" class="layui-input" placeholder="请输入控制器">
        </div> 
        </div>
       </td>         
     </tr>
     ...
     <thead>
      <tr>                        
       <td>
        ...
        <div class="layui-input-inline">         
          <input type="text"  name="method" class="layui-input" placeholder="请输入方法" >
        </div> 
        </div>
       </td>         
     </tr>
...
<script type="text/javascript">
    ...
    function save(){
      ...
      $.post("<?php echo url('Panel/save_add'); ?>",{'title':title,'icon':icon,'controller':controller,'method':method},function(res){
       if(res.code>0){
        layer.alert(res.msg,{icon:2});
      }else{
        layer.msg(res.msg);
