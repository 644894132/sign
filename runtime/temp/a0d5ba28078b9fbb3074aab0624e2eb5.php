<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:92:"D:\phpstudy\PHPTutorial\WWW\sign\public/../application/admin\view\meeting\teacher_label.html";i:1572574556;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\head.html";i:1570699778;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\foot.html";i:1572840312;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
...
<style type="text/css">
 ...
 <div class="layui-form-item">
  <br>
  &nbsp;&nbsp;&nbsp;&nbsp;<span class="layui-btn layui-btn-radius layui-btn-disabled"><b style="color:#000000">老师标签</b><hr>  
  <table class="layui-table">
    ...
    <?php if(is_array($data['lists']) || $data['lists'] instanceof \think\Collection || $data['lists'] instanceof \think\Paginator): $i = 0; $__LIST__ = $data['lists'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
     <tr>
      <td><a class="layui-btn teacher_label" href="<?php echo url('Meeting/label_assign'); ?>?MeetingID=<?php echo $MeetingID; ?>&labelid=<?php echo $vo['id']; ?>" target="iframeb">
      <span><?php echo $vo['labels']; ?></span></a>
      </td>
     </tr>
...
<script type="text/javascript"> 
  $(function(){
    $(".teacher_label").each(function(index){
      let location = index + 1;
      if (location == 1) {
       $(this).addClass("active").find("span").trigger("click"); 
        return false;
      }     
    })
    $("a.teacher_label").off('click').on("click", function() {
      $("a.teacher_label").removeClass("active");
