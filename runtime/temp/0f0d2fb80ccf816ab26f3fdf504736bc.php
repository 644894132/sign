<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"D:\phpstudy\PHPTutorial\WWW\sign\public/../application/admin\view\panel\add_role.html";i:1572571853;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\head.html";i:1570699778;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\foot.html";i:1572573889;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
...
<script type="text/javascript">
    ...
    function save_role(){
      ...
      $.post("<?php echo url('Panel/save_role'); ?>",$('form').serialize(),function(res){
          if(res.code >0){
