<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:98:"D:\phpstudy\PHPTutorial\WWW\sign\public/../application/admin\view\meeting\meeting_particulars.html";i:1567579998;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\head.html";i:1566614346;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\foot.html";i:1567147564;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
       ...
       <table>      
             ...
             <tr>
               <td>
                ...
                <div class="layui-input-inline">
                 <input type="text" name="title" class="layui-input"  value="<?php echo $data['item']['title']; ?>">
                </div> 
                </div>
               </td>             
             </tr>
          ...
          <thead>
             <tr>
               <td>
                ...
                <div class="layui-input-inline">
                 <input type="text" name="start" class="layui-input" value="{date('Y-m-d H:i:s',$data.item.start)}">
                </div> 
                </div>
               </td>             
             </tr>
          ...
          <thead>
             <tr>
               <td>
                ...
                <div class="layui-input-inline">
                 <input type="text" name="end" class="layui-input" value="<?php echo $data['item']['end']; ?>">
                </div> 
                </div>
               </td>             
             </tr>
          ...
          <thead>
             <tr>
               <td>
                ...
                <div class="layui-input-inline">
                 <input type="text" name="attn" class="layui-input" value="<?php echo $data['item']['attn']; ?>">
                </div> 
                </div>
               </td>             
             </tr>
          ...
          <thead>
             <tr>
               <td>
                ...
                <div class="layui-input-inline">
                 <input type="text" name="telephone" class="layui-input" placeholder="请输入标签名称" value="<?php echo $data['item']['telephone']; ?>">
                </div> 
                </div>
               </td>             
             </tr>
          ...
          <thead>
             <tr>
               <td>
                <div class="layui-form-item">
                 <label class="layui-form-label">会议主办单位</label>
                <div class="layui-input-inline">
                 <input type="text" name="teamwork" class="layui-input" placeholder="请输入标签名称" value="<?php echo $data['item']['teamwork']; ?>">
                </div> 
                </div>
               </td>             
             </tr>
