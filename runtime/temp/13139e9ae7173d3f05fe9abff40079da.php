<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:93:"D:\phpstudy\PHPTutorial\WWW\sign\public/../application/admin\view\panel\update_son_menus.html";i:1572591231;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\head.html";i:1570699778;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\foot.html";i:1572573889;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
  ...
  <form class="layui-form">  
       ...
       <tbody>
        <tr>                        
         <td>
          ...
          <div class="layui-input-inline">
            <input type="text"  name="titles" class="layui-input" placeholder="请输入栏目名称" value="" >
          </div> 
          </div>
         </td>         
        </tr>
       ...
       <!-- <thead>
        <tr>                        
         <td>
          ...
          <div class="layui-input-inline">         
            <input type="text"  name="icon" class="layui-input" placeholder="请输入图标" value="">
          </div> 
          </div>
         </td>         
       </tr>
       ...
       <thead>
        <tr>                        
         <td>
          ...
          <div class="layui-input-inline">         
            <input type="text"  name="controller" class="layui-input" placeholder="请输入控制器" value="">
          </div> 
          </div>
         </td>         
       </tr>
       ...
       <thead>
        <tr>                        
         <td>
          ...
          <div class="layui-input-inline">         
            <input type="text"  name="method" class="layui-input" placeholder="请输入方法" value="">
          </div> 
          </div>
         </td>         
       </tr>
       ...
       <thead>
        <tr>                        
         <td>
          ...
          <div class="layui-input-inline">         
            <input type="text"  name="order" class="layui-input" placeholder="请输入排序" value="">
          </div> 
          </div>
         </td>         
       </tr>
    ...
    <div class="layui-form-item"> 
      <button type="button" class="layui-btn" style="margin-left:120px" onclick="save('')">保存</button>
    </div>    
  </form>  
<script type="text/javascript" src="/static/plugins/layui/layui.js"></script>
...
<script type="text/javascript">
  ...
  function save(mid){
    ...
    $.post("<?php echo url('Panel/save_update'); ?>",{'mid':mid,'title':title,'icon':icon,'controller':controller,'method':method,'ord':ord},function(res){
     if(res.code>0){
      layer.alert(res.msg,{icon:2});
    }else{
      layer.msg(res.msg);
