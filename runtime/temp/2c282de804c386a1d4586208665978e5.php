<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:91:"D:\phpstudy\PHPTutorial\WWW\sign\public/../application/admin\view\label\label_maintain.html";i:1572227961;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\head.html";i:1570699778;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\foot.html";i:1571801470;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
...
<script type="text/javascript">
    ...
    //搜索
     function searchs(curpage){
      ...
      var url ="/admin.php/admin/Label/label_maintain?labelid="+labelid+"&page="+curpage;
      //console.log(url);
      if(seek){
        //将搜索到的内容拼接至分页后面
        url+='&seek='+seek;
  ...
  //console.log(arr);
  // return ;
     $.post('/admin.php/admin/Label/confirm',{'checkAll':arr,'id':id},function(res){       
      if(res.code>0){
        layer.alert(res.msg,{icon:2});
      }else{
            layer.msg(res.msg);
