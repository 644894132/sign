<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:91:"D:\phpstudy\PHPTutorial\WWW\sign\public/../application/admin\view\panel\main_interface.html";i:1572573538;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\head.html";i:1570699778;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\foot.html";i:1572573889;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
...
<div class="header">
  ...
  <div></div>
   ...
   <div class="layui-form-item"> 
	  <span>
	    <iframe id="iframeA" name="iframea" src="<?php echo url('Panel/label_maintain'); ?>?labelid=<?php echo $labelid; ?>"  height="800px" width="47%" style="padding:10px;" frameborder="no" scrolling="atuo"></iframe>
	  </span>
	  <span>
	    <iframe id="iframeB" name="iframeb" src="<?php echo url('Panel/assign_personnel'); ?>?labelid=<?php echo $labelid; ?>" height="800px" width="50%" style="padding:10px;" frameborder="no" scrolling="atuo"></iframe>
	   </span>
  </div>   
<script type="text/javascript" src="/static/plugins/layui/layui.js"></script>
