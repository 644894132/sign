<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:96:"D:\phpstudy\PHPTutorial\WWW\sign\public/../application/admin\view\gather\meeting_statistics.html";i:1571297686;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\head.html";i:1570699778;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\foot.html";i:1572849076;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
...
<script type="text/javascript">
    ...
    function month(obj){
     ...
     $.ajax({
        type: 'post',
        async :true,
        url :"<?php echo url('Gather/month_meeting'); ?>",
        data :[],
        dataType :'json',
   ...
   $(obj).addClass("active");
    $("#month").removeClass("active");
     ...
     $.ajax({
        type: 'post',
        async :true,
        url :"<?php echo url('Gather/year_meeting'); ?>",
        data :[],
        dataType :'json',
        success :function(data){
            //json数据转为数组
