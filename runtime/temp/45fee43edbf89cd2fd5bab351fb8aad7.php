<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:97:"D:\phpstudy\PHPTutorial\WWW\sign\public/../application/admin\view\gather\meeting_invite_list.html";i:1567499237;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\head.html";i:1566614346;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\foot.html";i:1567147564;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;<span class="layui-btn layui-btn-radius layui-btn-primary"><b style="color:#000000">邀请参会老师列表</b></span><hr><br> 
 ...
 <div class="layui-form-item">
   <button class="layui-btn layui-btn-lg" style="margin-left: 200px;" onclick="del()">删除</button>
 </div>
<script type="text/javascript" src="/static/plugins/layui/layui.js"></script>
...
<script type="text/javascript"> 
      ...
      function del(id){
        ...
        layer.confirm('确认要删除吗?', {
          ...
          //提交数据，跳转页面
          $.post('/admin.php/admin/Meeting/remove',{'checkAll':arr},function(res){
            if(res.code>0){
