<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"D:\phpstudy\PHPTutorial\WWW\sign\public/../application/admin\view\home\update_pwd.html";i:1568877652;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\head.html";i:1570699778;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\foot.html";i:1571221383;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
...
<script type="text/javascript"> 
     ...
     function save_update(){
      ...
      $.post('/admin.php/admin/Home/save_update',{'new_pwd':new_pwd,'former_pwd':former_pwd,'verify_new_pwd':verify_new_pwd},function(res){
     if(res.code>0){
      layer.alert(res.msg,{icon:2});
    }else{
      layer.msg(res.msg);
