<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:90:"G:\PHPstudayV8\phpstudy_pro\WWW\sign\public/../application/admin\view\panel\user_info.html";i:1572573746;s:76:"G:\PHPstudayV8\phpstudy_pro\WWW\sign\application\admin\view\common\head.html";i:1570699779;s:76:"G:\PHPstudayV8\phpstudy_pro\WWW\sign\application\admin\view\common\foot.html";i:1572849076;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
...
<script type="text/javascript">
  ...
  layui.use(['layer','laypage'],function(){
   ...
   function searchs(curpage){
    ...
    //有wd就加载至分页后面
    var url ="<?php echo url('Panel/user_info'); ?>?page="+curpage;
    //var_dump(url);
    if(seek){
      //将搜索到的内容拼接至分页后面
      url+='&seek='+seek;
   ...
   //更新
   function update(){
    setTimeout(function(){window.location.href="<?php echo url('Panel/user_info'); ?>";},500);
   }
     //角色设置
      function role_set(Account){
        ...
        layer.open({
          ...
          area: ['500px', '500px'],
          //URL地址
          content: '<?php echo url("Panel/role_set"); ?>?Account='+Account //iframe的url  
       });
     }
</script>