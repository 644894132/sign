<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"D:\phpstudy\PHPTutorial\WWW\sign\public/../application/admin\view\panel\site.html";i:1572434342;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\head.html";i:1570699778;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\foot.html";i:1572840312;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
...
<form class="layui-form" style="margin-top:10px;"> 
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      <input type="text" class="layui-input" name="names" value="<?php echo $data['item']['names']; ?>">
    </div>
  </div>
  <div class="layui-form-item">
    <label class="layui-form-label">系统简称</label>
    <div class="layui-input-inline">
      <input type="text" class="layui-input" name="abbreviation" value="<?php echo $data['item']['abbreviation']; ?>">
    </div>
  </div>
  <div class="layui-form-item">
    <label class="layui-form-label">版权所有权</label>
    <div class="layui-input-inline">
      <input type="text" class="layui-input" name="copy" value="<?php echo $data['item']['copy']; ?>">
    </div>
  </div>   
  <div class="layui-form-item">
    <label class="layui-form-label">系统描述</label>
    <div class="layui-input-inline">
      <input type="text" class="layui-input" name="describe" value="<?php echo $data['item']['describe']; ?>">
    </div>
  </div>
  <div class="layui-form-item">
    <label class="layui-form-label">系统关键字</label>
    <div class="layui-input-inline">
      <input type="text" class="layui-input" name="keyword" value="<?php echo $data['item']['keyword']; ?>">
    </div>
  </div>
  <div class="layui-form-item">
    <label class="layui-form-label">联系方式</label>
    <div class="layui-input-inline">
      <input type="text" class="layui-input" name="contact_way"  maxlength="11" value="<?php echo $data['item']['contact_way']; ?>">
    </div>
  </div>
  <div class="layui-form-item">
    <label class="layui-form-label">技术支持</label>
    <div class="layui-input-inline">
      <input type="text" class="layui-input" name="support" value="<?php echo $data['item']['support']; ?>">
    </div>
  </div>
</form>	
<div class="layui-form-item">
  <div class="layui-input-block">
    <button class="layui-btn"  onclick="save_site()">提交</button>
  </div>
</div>
<script type="text/javascript" src="/static/plugins/layui/layui.js"></script>
...
<script type="text/javascript">
    function save_site(){
     $.post("<?php echo url('Panel/save_site'); ?>",$('form').serialize(),function(res){
     	if(res.code>0){
