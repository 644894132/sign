<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:91:"D:\phpstudy\PHPTutorial\WWW\sign\public/../application/admin\view\meeting\teacher_list.html";i:1567231988;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\head.html";i:1566614346;s:73:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\share.html";i:1567130184;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\foot.html";i:1567147564;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
		...
		<table class="layui-table">
         ...
         <td>部门</td>
	      ...
	      <?php if(is_array($data['data']['lists']) || $data['data']['lists'] instanceof \think\Collection || $data['data']['lists'] instanceof \think\Paginator): $i = 0; $__LIST__ = $data['data']['lists'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
		    <tr>		      
		     <td><input type="checkbox" class="checkAll" name="checkAll[]" value="<?php echo $vo['Account']; ?>" onclick="selectAll(this)"></td>
		     <td><?php echo $vo['Account']; ?></td>
         <td><?php echo $vo['Name']; ?></td>
         <td><?php echo $vo['Sex']==1?'<span style="color:red">男</span>':'<span style="color:green">女</span>'; ?></td>
  ...
  <div class="layui-form-item">
     <button class="layui-btn  layui-btn-lg" style="margin-left: 850px;" onclick="Invite()">邀请</button>
  </div>
...
<script type="text/javascript"> 
     ...
     laypage =layui.laypage;
      ...
      laypage.render({
        ...
        jump:function(obj,first){
          //判断
          if(!first){
             window.location.href ="?meeting_number=<?php echo $labelid; ?>&page="+obj.curr;
             // let a ="?labelid=<?php echo $labelid; ?>&page="+obj.curr;
             // console.log(a);
             //searchs(obj.curr);
          }
        }
       ...
       function searchs(curpage){
        ...
        //有wd就加载至分页后面
        var url ="/admin.php/admin/Label/label_maintain?meeting_number=<?php echo $labelid; ?>&page="+curpage;
        //var_dump(url);
        if(seek){
          //将搜索到的内容拼接至分页后面
          url+='&seek='+seek;
  ...
  // console.log(id);
  // return ;
     $.post('/admin.php/admin/Meeting/save_invite',{'checkAll':arr,'id':id},function(res){       
