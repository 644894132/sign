<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"D:\phpstudy\PHPTutorial\WWW\sign\public/../application/admin\view\meeting\homepage.html";i:1572574247;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\head.html";i:1570699778;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\foot.html";i:1572840312;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
 ...
 <div  class="layui-form-item">
  <span>
    <iframe id="iframeA" name="iframea" class="iframea" src="<?php echo url('Meeting/teacher_label'); ?>?MeetingID=<?php echo $MeetingID; ?>" height="780px" width="15%" frameborder="no"  scrolling="auto" style="padding:10px;"></iframe>
  </span>
  <span>
    <iframe id="iframeB" name="iframeb" class="iframeb" src="<?php echo url('Meeting/label_assign'); ?>?MeetingID=<?php echo $MeetingID; ?>" height="780px" width="40%" frameborder="no"  style="padding:10px;" scrolling="auto"></iframe>
  </span> 
  <span>
    <iframe id="iframeC" name="iframec" class="iframec" src="<?php echo url('Meeting/invite_teacher_info'); ?>?MeetingID=<?php echo $MeetingID; ?>" height="780px" width="40%" frameborder="no" style="padding:10px;" scrolling="auto"></iframe>
  </span>
 </div>
<script type="text/javascript" src="/static/plugins/layui/layui.js"></script>
