<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:93:"D:\phpstudy\PHPTutorial\WWW\sign\public/../application/admin\view\label\assign_personnel.html";i:1571107859;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\head.html";i:1570699778;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\foot.html";i:1571801470;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
...
<script type="text/javascript"> 
     ...
     function searchs(curpage){
      ...
      //有wd就加载至分页后面
      var url ="/admin.php/admin/Label/assign_personnel?labelid="+labelid+"&page="+curpage;
      //var_dump(url);
      if(seek){
        //将搜索到的内容拼接至分页后面
        url+='&seek='+seek;
    ...
    layer.confirm('确认要删除吗?', {
      ...
      //提交数据，跳转页面
      $.post('/admin.php/admin/Label/remove',{'checkAll':arr,'id':id},function(res){
        if(res.code>0){
            layer.alert(res.msg,{icon:2});
        }else{
            layer.msg(res.msg);
