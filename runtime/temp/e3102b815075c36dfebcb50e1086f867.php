<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:99:"D:\phpstudy\PHPTutorial\WWW\sign\public/../application/admin\view\cartogram\meeting_statistics.html";i:1570785772;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\head.html";i:1570699778;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\foot.html";i:1570788077;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
...
<script type="text/javascript">
    ...
    function month(obj){
     ...
     $.ajax({
        type: 'post',
        async :true,
        url :"<?php echo url('Cartogram/month_meeting'); ?>",
        data :[],
        dataType :'json',
   ...
   $(obj).addClass("active");
    $("#month").removeClass("active");
     ...
     $.ajax({
        type: 'post',
        async :true,
        url :"<?php echo url('Cartogram/year_meeting'); ?>",
        data :[],
        dataType :'json',
        success :function(data){
            //json数据转为数组
