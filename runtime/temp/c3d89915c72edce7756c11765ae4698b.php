<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"D:\phpstudy\PHPTutorial\WWW\sign\public/../application/admin\view\label\add.html";i:1571304808;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\head.html";i:1570699778;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\foot.html";i:1571801470;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
...
<script type="text/javascript">
   ...
   function save(){
     ...
     //判断
      ...
      //提交
      $.post('/admin.php/admin/Label/save',$('form').serialize(),function(res){
         if(res.code >0){
            layer.alert(res.msg,{icon:2});
         }else{
            layer.msg(res.msg);
