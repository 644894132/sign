<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:97:"D:\phpstudy\PHPTutorial\WWW\sign\public/../application/admin\view\gather\no_participate_info.html";i:1567992699;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\head.html";i:1566614346;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\foot.html";i:1567993633;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
  ...
  <body  class="layui-layout-body">
   ...
   <div class="header">
      <span>未参加人员列表</span>
      <button class="layui-btn" style="float:right;" onclick="sign_add()"><i class="layui-icon">&#xe608;</i>添加</button>
       <button class="layui-btn layui-btn-xs" onclick="back()">返回</button>
      <div></div>
     </div>
   <div>
   <div>
      <table class="layui-table" style="margin-left:20px;margin-right:20px;">
         ...
         <thead>
             <?php if(is_array($data['lists']) || $data['lists'] instanceof \think\Collection || $data['lists'] instanceof \think\Paginator): $i = 0; $__LIST__ = $data['lists'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if(($vo['sign_status']==0)): ?>
             <tr>
