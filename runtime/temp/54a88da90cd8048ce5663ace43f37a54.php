...
<form class="layui-form">
   <div class="layui-form-item">
      ...
      <div class="layui-input-block">
        <input type="text" class="layui-input" name="title" value="<?php echo $role['name']; ?>">  
      </div>
   </div>
...
<script type="text/javascript">
    ...
    function save(){
      ...
      if(title ==''){
         layer.msg('请填写用户名称',{'icon':2});
         return;
      }
      $.post('/admin.php/admin/Jurisdiction/save',$('form').serialize(),function(res){
          if(res.code >0){
