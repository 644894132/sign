<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"D:\phpstudy\PHPTutorial\WWW\sign\public/../application/admin\view\panel\index.html";i:1572573311;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\head.html";i:1570699778;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\foot.html";i:1572840312;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
  ...
  //引用layui主键
      layui.use(['layer','laypage'],function(){
       ...
       function searchs(curpage){
        ...
        var url ="<?php echo url('Panel/index'); ?>?page="+curpage;
        //var_dump(url);
        if(seek){
          //将搜索到的内容拼接至分页后面
          url+='&seek='+seek;
    ...
    //添加
      function add(id){
        ...
        layer.open({
          ...
          area: ['450px', '400px'],
          //URL地址
          content: '<?php echo url("Panel/label_add"); ?>?id='+id //iframe的url  
       });
     }
       /* //删除
      function remove(id){
      ...
      function remove(id){
        ...
        layer.confirm('确认要删除吗?', {
          ...
          //提交数据，跳转页面
          $.post("<?php echo url('Panel/delete_label'); ?>",{'id':id},function(res){
            if(res.code>0){
      ...
      function person_assign(id){
        ...
        let url = "<?php echo url('Panel/main_interface'); ?>?id="+id;
        // console.log(url);
        window.location.href = url;
      }
</script>