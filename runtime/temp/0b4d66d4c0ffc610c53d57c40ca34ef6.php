<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:93:"D:\phpstudy\PHPTutorial\WWW\sign\public/../application/admin\view\jurisdiction\user_info.html";i:1571300205;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\head.html";i:1570699778;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\foot.html";i:1571366652;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
...
<script type="text/javascript">
  ...
  layui.use(['layer','laypage'],function(){
   ...
   function searchs(curpage){
    ...
    //有wd就加载至分页后面
    var url ="/admin.php/admin/Jurisdiction/user_info?page="+curpage;
    //var_dump(url);
    if(seek){
      //将搜索到的内容拼接至分页后面
      url+='&seek='+seek;
   ...
   //更新
   function update(){
    setTimeout(function(){window.location.href="<?php echo url('Jurisdiction/user_info'); ?>";},500);
   }
     //角色设置
      function role_set(Account){
        ...
        layer.open({
          ...
          area: ['500px', '500px'],
          //URL地址
          content: '/admin.php/admin/Jurisdiction/role_set?Account='+Account //iframe的url  
       });
     }
</script>