<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"D:\phpstudy\PHPTutorial\WWW\sign\public/../application/admin\view\panel\label_add.html";i:1572571931;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\head.html";i:1570699778;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\foot.html";i:1572573889;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
             ...
             <tr>
               <td>
                ...
                <div class="layui-input-inline">
                 <input type="text" name="labels" class="layui-input" placeholder="请输入标签名称" value="<?php echo $data['item']['labels']; ?>">
                </div> 
                </div>
               </td>             
             </tr>
...
<script type="text/javascript">
   ...
   function save(){
     ...
     //判断
      ...
      //提交
      $.post("<?php echo url('Panel/save_label'); ?>",$('form').serialize(),function(res){
         if(res.code >0){
            layer.alert(res.msg,{icon:2});
         }else{
            layer.msg(res.msg);
