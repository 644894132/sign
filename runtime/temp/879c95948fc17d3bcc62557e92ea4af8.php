<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:89:"D:\phpstudy\PHPTutorial\WWW\sign\public/../application/admin\view\jurisdiction\menus.html";i:1571305838;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\head.html";i:1570699778;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\foot.html";i:1571366652;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
...
<script type="text/javascript">
    //子菜单
     function child(pid){
       window.location.href ="/admin.php/admin/Jurisdiction/menus?pid="+pid;
     }
     //返回上一级
     function back(pid){
       window.location.href ="/admin.php/admin/Jurisdiction/menus?pid="+pid;
     ...
     //保存
    function save_menus(){
       $.post('/admin.php/admin/Jurisdiction/save_menus',$('form').serialize(),function(res){
         if(res.code >0){
         	layer.alert(res.msg,{icon:2});
         }else{
