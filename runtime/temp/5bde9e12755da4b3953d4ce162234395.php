<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:95:"D:\phpstudy\PHPTutorial\WWW\sign\public/../application/admin\view\jurisdiction\role_manage.html";i:1571046839;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\head.html";i:1570699778;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\foot.html";i:1571366652;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
    ...
    function add_role(id){
      layer.open({
       type: 2,
        ...
        shade: 0.3,
        area: ['800px', '700px'],
        content: '/admin.php/admin/Jurisdiction/add_role?id='+id //iframe的url
      });
    }
    //删除角色
    function del(id){
      //询问框
        layer.confirm('确认要删除吗?', {
          ...
          //提交数据，跳转页面
          $.post('/admin.php/admin/Jurisdiction/delete',{'id':id},function(res){
            if(res.code>0){
                layer.alert(res.msg,{icon:2});
            }else{
                layer.msg(res.msg);
