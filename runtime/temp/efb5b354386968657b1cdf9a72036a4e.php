<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"D:\phpstudy\PHPTutorial\WWW\sign\public/../application/admin\view\meeting\audit.html";i:1572600074;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\head.html";i:1570699778;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\foot.html";i:1572840312;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
...
<script type="text/javascript">
  ...
  function consent(id){
    ...
    layer.confirm('确认要同意吗?', {
      ...
      //提交数据，跳转页面
      $.post("<?php echo url('Meeting/consent'); ?>",{'id':id},function(res){
        if(res.code >0){
            layer.alert(res.msg,{icon:2});
          }else{
            layer.msg(res.msg);
  ...
  function disagree(id){
    ...
    layer.confirm('确认不同意吗?', {
      ...
      //提交数据，跳转页面
      $.post("<?php echo url('Meeting/disagree'); ?>",{'id':id},function(res){
        if(res.code>0){
