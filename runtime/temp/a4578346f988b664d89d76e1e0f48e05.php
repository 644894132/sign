...
<script type="text/javascript">
    ...
    function save_role(){
      ...
      $.post('/admin.php/admin/Jurisdiction/save_role',$('form').serialize(),function(res){
          if(res.code >0){
