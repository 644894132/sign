<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:97:"D:\phpstudy\PHPTutorial\WWW\sign\public/../application/admin\view\gather\conferee_statistics.html";i:1572574002;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\head.html";i:1570699778;s:72:"D:\phpstudy\PHPTutorial\WWW\sign\application\admin\view\common\foot.html";i:1572849076;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
 ...
 <div class="header">
  <span>与会人数统计</span>
  <!-- <a class="layui-btn" style="float:right;margin-top:8px;" href="<?php echo url('Gather/download'); ?>"><i class="layui-icon">&#xe601;</i>生成Excel文件</a>  -->
   <div></div><br>
 </div> 
 <table class="layui-table">
   <thead>
     ...
     <?php if(is_array($data['lists']) || $data['lists'] instanceof \think\Collection || $data['lists'] instanceof \think\Paginator): $key = 0; $__LIST__ = $data['lists'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
     <tr>
       <td><?php echo $key; ?></td>
       <td><a href="javascript:;" onclick="meeting_add(<?php echo $vo['id']; ?>, 3)"><?php echo $vo['title']; ?></a></td>
       <td><a href="<?php echo url('Meeting/invite_teacher_info'); ?>?op=1&MeetingID=<?php echo $vo['id']; ?>"><?php echo $vo['meeting_count']; ?></a></td>
       <td><a href="<?php echo url('Gather/sign_info'); ?>?meeting_id=<?php echo $vo['id']; ?>"><?php echo $vo['sign_nums']; ?></a></td>
       <td><a href="<?php echo url('Gather/leave_info'); ?>?meeting_id=<?php echo $vo['id']; ?>"><?php echo $vo['leave_nums']; ?></a></td>        
       <td><a href="<?php echo url('Gather/absent_info'); ?>?meeting_id=<?php echo $vo['id']; ?>"><?php echo $vo['absent_nums']; ?></a></td>               
     </tr>
...
function remove(id){
  ...
  layer.confirm('确认要删除吗?', {
    ...
    //提交数据，跳转页面
    $.post("<?php echo url('Gather/delete'); ?>",{'id':id},function(res){
      if(res.code>0){
